        ...
        <div class="container">
            <div class="row gutters-16">
                ...
                <div class="col-xl-9 order-0 order-xl-1">
                    ...
                    <div class="bg-blue mb-4 border p-4">
                        <!-- Tabs -->
                    ...
                    <div class="p-3">
                        ...
                        @if(get_setting('google_login') == 1 ||
                            ...
                            <div class="separator mb-3">
                                <span class="bg-blue px-3 opacity-60">{{ translate('Or Login With')}}</span>
                            </div>
