...
<body>
    <!-- aiz-main-wrapper -->
    <div class="aiz-main-wrapper d-flex flex-column bg-blue">
        @php
            $user = auth()->user();
            $user_avatar = null;
            $carts = [];
                ...
                <div class="modal website-popup removable-session d-none" data-key="website-popup-{{ $dynamic_popup->id }}" data-value="removed">
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-zoom modal-md mx-4 mx-md-auto">
                        <div class="modal-content position-relative border-0 rounded-0">
                            ...
                            <button class="absolute-top-right bg-black shadow-lg btn btn-circle btn-icon mr-n3 mt-n3 set-session" data-key="website-popup-{{ $dynamic_popup->id }}" data-value="removed" data-toggle="remove-parent" data-parent=".website-popup">
                                <i class="la la-close fs-20"></i>
                            </button>
                        </div>
                    </div>
