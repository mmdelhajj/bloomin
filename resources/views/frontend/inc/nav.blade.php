    ...
    <!-- Top Bar -->
    <div class="top-navbar bg-blue z-1035 h-35px h-sm-auto">
        <div class="container">
            <div class="row">
    ...
    <header class="@if (get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-blue">
        <!-- Search Bar -->
        <div class="position-relative logo-bar-area border-bottom border-md-nonea z-1025">
            <div class="container">
                <div class="d-flex align-items-center">
                    ...
                    <!-- Header Logo -->
                    <div class="col-auto pl-9 pr-3 d-flex align-items-center">
                        <a class="d-block py-20px mr-3 ml-0" href="{{ route('home') }}">
                            ...
                            @if ($header_logo != null)
                                <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}"
                                    class="mw-100 h-60px h-md-80px" height="40">
                            @else
                    ...
                    <!-- Search field -->
                    <div class="flex-grow-1 front-header-search d-flex align-items-center bg-blue mx-xl-5">
                            ...
                            <form action="{{ route('search') }}" method="GET" class="stop-propagation">
                                <div class="d-flex position-relative align-items-center">
                                    ...
                                    <div class="search-input-box">
                                        <input type="text"
                                            class="border bg-white form-control fs-18 hov-animate-outline"
        ...
        <!-- Menu Bar -->
        <div class="d-none d-lg-block position-relative bg-blue h-50px">
