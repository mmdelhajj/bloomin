...
class AddressController extends Controller
{
    ...
    public function updateAddressInCart(Request $request)
    {
        ...
        if($authUser != null){
            ...
            Cart::where('user_id', $authUser->id)->update(['address_id' => $request->address_id]);
    ...
    public function updateShippingTypeInCart(Request $request)
    {
        try {
            ...
            $carts         = ($userId != null) ? Cart::where('user_id', $userId)->get() : Cart::where('temp_user_id', $tempUserId)->get();
